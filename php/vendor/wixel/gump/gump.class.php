		...
		foreach($this->errors as $e) {
			...
			switch($e['rule']) {
				...
				case 'validate_required':
					$resp[] = "Champ <span class=\"$field_class\">$field</span> requis";
					break;
				case 'validate_valid_email':
					$resp[] = "Veuillez entrer une addresse e-mail valide";
					break;
		...
		foreach($this->errors as $e) {
			...
			switch($e['rule']) {
				case 'mismatch' :
					...
					break;
				case 'validate_required':
					$resp[$field] = "Champ $field requis"; //$field 
					break;
				case 'validate_valid_email':
					$resp[$field] = "Veuillez entrer une adresse e-mail valide";
					break;
				case 'validate_max_len':
					if($param == 1) {
